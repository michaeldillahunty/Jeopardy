...
// THIS CODE DOES NOT BELONG TO ME AND WAS TAKEN FROM PROFESSOR WERGELES SWITCHABLE LECTURE CODE

public abstract class Switchable {
    
    public static String playerName = "Unknown User"; // "Unknown User" = default name
